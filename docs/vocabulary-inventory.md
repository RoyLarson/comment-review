...
| ~~**original**~~ | SETTLED 2026-08-16 — **common usage, no definition needed** | Roy: *"always the original text in the comment or file — fits common usage and stays pretty clean."* One sense at 6 sites: the block's prose BEFORE this run edited it. Left as written; a word that reads correctly to anyone does not need a statement |
