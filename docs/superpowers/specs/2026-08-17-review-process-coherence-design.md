...
| --- | --- | --- | --- |
| 728 | identical sentence | collision | **collision** yes |
| 981 | disjoint sentences | collision | **clear** yes |
| 1575 | identical sentence | collision | **collision** yes |
...
fix remains.** Measured: 15 blocks cite `CLAUDE.md stage N` where the stage scheme belongs to
