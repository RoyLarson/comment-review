...
def main() -> int:
    ...
    # travels with each edit: its `raw_lines` is the census's transcription of
    # the block -- the file's own lines for a comment run, the AST value for a
    # docstring -- and comparing the file to itself would make the staleness
