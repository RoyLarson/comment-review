...
| [vocabulary-gate-is-red](vocabulary-gate-is-red.md) | systems | — | 2/8 | check_vocabulary exits 1 on this branch and no test asserts check_drift |
...
| [requires-roy-never-goes-back-down](requires-roy-never-goes-back-down.md) | systems | — | 5/7 | nothing recomputes it or prompts the clearing; 6 cleared, 26 left to read |
...
| [the-parser-merges-across-boundaries-it-cannot-read](the-parser-merges-across-boundaries-it-cannot-read.md) | backend | yes | 2/4 | The collator merges across a boundary it cannot read, and blames the neighbour |
...
| [rubric-ab-boundary](rubric-ab-boundary.md) | agents | yes | 0/3 | detection graded B three times and A twice on an identical factual account |
