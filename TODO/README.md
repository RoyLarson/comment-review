...
| [python-cannot-read-python](python-cannot-read-python.md) | session | yes | 0/28 | the AST cannot read syntax newer than the floor, and two readers hide each other's bugs |
