...
| [doc-does-not-fill-its-a](doc-does-not-fill-its-a.md) | backend | yes | 4/8 | the a place now exists for Rust/Go/etc but the doc that fills it still sits at b |
...
| [brief-change-is-raw-text](brief-change-is-raw-text.md) | agents | -- | 2/2 | reviewer-brief.md:140 says change is the updated paragraph as RAW TEXT, not lines; desk/mark.py refuses a change that is not an ARRAY of lines, on a measurement of its own |
