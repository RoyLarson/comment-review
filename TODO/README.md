...
| [python-cannot-read-python](python-cannot-read-python.md) | session | yes | 0/27 | the AST cannot read syntax newer than the floor, and two readers hide each other's bugs |
...
| [lexer-and-language-findings](lexer-and-language-findings.md) | comment-review | — | 1/14 | Ten findings in lexer.py and language.py, from three review rounds |
