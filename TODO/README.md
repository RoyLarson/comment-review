...
| [python-cannot-read-python](python-cannot-read-python.md) | session | yes | 0/22 | the AST cannot read syntax newer than the floor, and two readers hide each other's bugs |
...
| [a-closing-quote-with-a-comment](a-closing-quote-with-a-comment.md) | session | — | 0/10 | the closing quote and the comment beside it are both stored, so the file gains a line |
