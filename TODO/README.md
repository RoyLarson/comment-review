...
| [7a-can-prove-the-change-by-applying-it-to-a-copy](7a-can-prove-the-change-by-applying-it-to-a-copy.md) | session * Roy (raised it, 2026-08-17) | — | 2/4 | 7a can PROVE the change by applying it to a copy and diffing |
| [a-block-does-not-say-where-its-text-starts](a-block-does-not-say-where-its-text-starts.md) | session | yes | 1/4 | A block does not say where its text starts, so two things infer it |
