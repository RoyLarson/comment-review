...
| [a-block-does-not-say-where-its-text-starts](a-block-does-not-say-where-its-text-starts.md) | session | yes | 7/9 | A block does not say where its text starts, so two things infer it |
