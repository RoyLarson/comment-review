...
| [a-block-does-not-say-where-its-text-starts](a-block-does-not-say-where-its-text-starts.md) | session | yes | 3/8 | A block does not say where its text starts, so two things infer it |
