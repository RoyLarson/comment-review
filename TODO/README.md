...
| [containers-and-verification-are-unwired](containers-and-verification-are-unwired.md) | backend | yes | 14/41 | The containers and the source-verification half are wired to nothing |
...
| [collate-command-defects](collate-command-defects.md) | backend | -- | 2/19 | Sixteen defects in `commands/collate.py`, measured by running it |
