...
| [ownership-is-read-first-but-nothing-makes-it-so](ownership-is-read-first-but-nothing-makes-it-so.md) | session (serialisation and 4b ruled 2026-08-17; the rest is build) | — | 3/10 | `ownership-context` is read FIRST, and nothing in the run makes that true |
...
| [stage-5-is-the-only-stage-with-no-independent-reader](stage-5-is-the-only-stage-with-no-independent-reader.md) | Roy | — | 1/9 | Stage 5 is the only stage whose writer is also its checker |
