...
- [x] `plugins/comment-review/.claude-plugin/plugin.json` is `0.2.3` while
...
- [x] ! CLAUDE.md also records that this exact failure happened before, three
      ...
      tag.
- [x] * RULING: which number this branch cuts. The version is stated in three
