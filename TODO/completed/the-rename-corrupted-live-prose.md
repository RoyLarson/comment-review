...
- [x] !! `SKILL.md:68`, INSIDE THE VERDICT TABLE: *"`query` | unsettled | resolve
      ...
      713f8af.
- [x] Twice more in `references/compact.md:30-31`: *"does not PARAGRAPH this
      pass"* and *"Read as 'unresolved PARAGRAPHS stage 6'"*.
- [x] !! `agents/comment-review-block-context.md:7-8` TELLS THE AGENT ITS OWN ROLE
...
- [x] `agents/comment-review-module-context.md:77` reads `an if __name__ ==
      "__main__": PARAGRAPH`.
- [x] `lexer.py:392` and `prove_unchanged.py:128` say *"a Java text PARAGRAPH"*.
