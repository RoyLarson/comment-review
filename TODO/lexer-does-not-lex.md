...
- [x] `lexer.py` DOES NOT LEX, at the tier that matters. Roy, 2026-08-22: *"this
...
- [x] ! THE OTHER TIER REALLY DOES LEX. `paragraphs_lexical` reads characters
...
- [x] ! WHY IT MATTERS BEYOND THE WORD: `scan` was ruled 2026-08-22 to mean the
...
- [x] ! WHAT IT MIGHT BE INSTEAD is not decided here, and the register should be
      ...
      that TODO settle it.
- [x] `TYPECODER` IS THE CANDIDATE, AND IT NAMES THE PRODUCT RATHER THAN THE
...
- [x] ! IT DISSOLVES THE NAMING HALF OF THIS FILE'S OWN TITLE. Two tiers read
...
- [x] ! NOT THE ADDRESSER, WHICH WAS THE FIRST GUESS. `cue(code, documentable,
      ...
      to content.
- [ ] * DETERMINE THE NAME. TYPECODER is the standing candidate; the register is
      asked before the computing word. ! Settle it AFTER the Python ruling lands,
      ...
      docs/vocabulary.md.
- [ ] RENAME. The module, its imports, the vocabulary entry and every prose use.
      Verify: `check_vocabulary.py` passes with the old word RETIRED and the new
      one defined, and the suite is green.
