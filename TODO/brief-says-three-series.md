...
- [ ] Decide what a role is told about the f series, and make reviewer-brief.md:69
      agree with SKILL.md:378
- [ ] Fix the --series a|b|c example at reviewer-brief.md:221 to the set the
      addresser command actually accepts
- [ ] Reconcile with reviewer-brief.md:74-79, which calls @f0 the file's own
      matter, filtered out of the census and not a place a role rules on -- if
      that still holds, say which of the four a role may cite and which it may
      only read
